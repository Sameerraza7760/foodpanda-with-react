      ...
      auth.onAuthStateChanged((user) => {
        if (user) {
          const filteredItems = restItem.filter(
            (item) => user.uid === item.id.slice(0, 28)
          );
    ...
    <>
      ...
      <div className="addItem-container">
        ...
        <Button
          type="primary"
          onClick={addModal}
          style={{ height: "50px", width: "150px", marginTop: "10%" }}
        >
          Add Items
        </Button>
        <hr />
        ...
        <Modal open={isModalOpen} onOk={handleOk} onCancel={handleCancel}>
          <h1 style={{ width: "100%", fontSize: "17px" }}>
            Add items in your restaurant
          </h1>
          <div style={{ height: "400px" }} className="inputContainerOfAddItem">
            ...
            <Input
              placeholder={placeholderText.itemdescription}
              id="itemdescription"
            />
            <Input placeholder={placeholderText.itemserving} id="itemserving" />
            <Input
              placeholder={placeholderText.itemcategory}
              id="itemcategory"
            />
            <input
